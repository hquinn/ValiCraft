...
public static class AsyncRuleChainsSyntaxProvider
{
        ...
        GeneratorAttributeSyntaxContext context)
    {
        ...
        var ruleChains = defineRulesMethodSyntax.Body!.Statements
            ...
            .Select(statement => AsyncRuleChainFactory.CreateFromStatement(statement, builderArgument, 0, IndentModel.CreateNew(), diagnostics, context))
            .OfType<RuleChain>()
