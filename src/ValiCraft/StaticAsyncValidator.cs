...
/// <summary>
/// Base class for creating static asynchronous validators. Inherit from this class and apply the
...
/// generate optimized static async validation methods. The method itself is never called at runtime.
/// </remarks>
/// <example>
/// <code>
/// [GenerateValidator]
...
/// </code>
/// </example>
public abstract class StaticAsyncValidator<TRequest> where TRequest : notnull
{
    /// <summary>
