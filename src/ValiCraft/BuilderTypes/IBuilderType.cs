    ...
    where TRequest : class
{
    ...
    IValidationRuleBuilderType<TRequest, TTarget> Is(
    ...
    IValidationRuleBuilderType<TRequest, TTarget> Is<TParam>(
    ...
    /// <returns>A validation rule builder for chaining further validation rules on the current target.</returns>
    IValidationRuleBuilderType<TRequest, TTarget> Is<TParam1, TParam2>(
    ...
    /// <returns>A validation rule builder for chaining further validation rules on the current target.</returns>
    IValidationRuleBuilderType<TRequest, TTarget> Is<TParam1, TParam2, TParam3>(
    ...
    /// <returns>A validation rule builder for chaining further validation rules on the current target.</returns>
    IValidationRuleBuilderType<TRequest, TTarget> Is<TParam1, TParam2, TParam3, TParam4>(
    ...
    /// <returns>A validation rule builder for chaining further validation rules on the current target.</returns>
    IValidationRuleBuilderType<TRequest, TTarget> Is<TParam1, TParam2, TParam3, TParam4, TParam5>(
    ...
    /// <returns>A validation rule builder for chaining further validation rules on the current target.</returns>
    IValidationRuleBuilderType<TRequest, TTarget> Is<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>(
