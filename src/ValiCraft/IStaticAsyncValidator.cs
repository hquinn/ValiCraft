...
public interface IStaticAsyncValidator<TRequest> where TRequest : class
{
    ...
    /// </returns>
    static abstract Task<Result<IValidationErrors, TRequest>> ValidateAsync(TRequest request, CancellationToken cancellationToken = default);
    ...
    static abstract Task<IReadOnlyList<IValidationError>> ValidateToListAsync(TRequest request, CancellationToken cancellationToken = default);
    ...
    static abstract Task<IReadOnlyList<IValidationError>> ValidateToListAsync(TRequest request, string? inheritedTargetPath, CancellationToken cancellationToken = default);
}
