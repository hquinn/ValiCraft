...
/// <summary>
/// Provides a set of static validation rules for various data types and conditions.
/// </summary>
public static class Rules
{
    ...
    [DefaultMessage("{TargetName} must be one of the allowed values")]
    [RulePlaceholder("{AllowedValues}", "allowedValues")]
    public static bool InValues<TTargetType>(TTargetType targetValue, params TTargetType[] allowedValues)
        where TTargetType : IEquatable<TTargetType>
    {
    ...
    [DefaultMessage("{TargetName} must not be one of the forbidden values")]
    [RulePlaceholder("{ForbiddenValues}", "forbiddenValues")]
    public static bool NotInValues<TTargetType>(TTargetType targetValue, params TTargetType[] forbiddenValues)
        where TTargetType : IEquatable<TTargetType>
    {
    ...
    public static bool ValidEnumName<TEnum>(string? targetValue)
    ...
    public static bool ValidEnumValue<TEnum, TValue>(TValue targetValue)
        where TEnum : struct, Enum
        where TValue : struct
    {
        return Enum.IsDefined(typeof(TEnum), targetValue);
