...
public class ValidatorGeneratorTests
{
    ...
    [StringSyntax("CSharp")]
    const string ValidationRulesToGenerate = 
        """
        using System;
        using ValiCraft;
    ...
    [StringSyntax("CSharp")]
    const string ValidationRulesAlreadyGenerated =
        """
        using System;
        using ValiCraft;
        using ValiCraft.Attributes;
        ...
        public static class NotNullRuleExtensions
        {
            ...
            public static IValidationRuleBuilder<TRequest, TPropertyType> IsNotNull<TRequest, TPropertyType>(
    ...
    [StringSyntax("CSharp")]
    const string ValidatorsToGenerate = """
                                        using Test.Rules;
                                        using Test.Requests;
                                        using ValiCraft;
                                        using ValiCraft.Attributes;
    ...
    [StringSyntax("CSharp")]
    const string ExpectedNotEmptyRuleExtensions = """
                                                  // <auto-generated />
                                                  #nullable enable
    ...
    [StringSyntax("CSharp")]
    const string ExpectedGreaterThanRuleExtensions = """
                                                     // <auto-generated />
                                                     #nullable enable
                                                     ...
                                                     namespace Test.Rules
                                                     {
                                                         ...
                                                         public static class GreaterThanRuleExtensions
                                                         {
                                                             ...
                                                             public static global::ValiCraft.BuilderTypes.IValidationRuleBuilderType<TRequest, TPropertyType> IsGreaterThan<TRequest, TPropertyType>(
                                                                 this global::ValiCraft.BuilderTypes.IBuilderType<TRequest, TPropertyType> builder, TPropertyValue valueToCompare) where TRequest : class where TPropertyValue : global::System.IComparable
                                                                 => throw new global::System.NotImplementedException("Never gets called");
                                                         }
                                                     }
                                                     """;
    ...
    [StringSyntax("CSharp")]
    const string ExpectedLessThanRuleExtensions = """
                                                  // <auto-generated />
                                                  #nullable enable
    ...
    [StringSyntax("CSharp")]
    const string ExpectedValidators = """
                                      // <auto-generated />
                                      #nullable enable
