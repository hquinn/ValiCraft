...
public class MultipleValidateWithRuleChains_UniqueErrorVariablesTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
    ...
    [StringSyntax("CSharp")] private const string InputValidatorsToGenerate = """
                                                                         ...
                                                                         [GenerateValidator]
                                                                         public partial class OrderValidator(IValidator<Customer> customerValidator, IValidator<LineItem> lineItemValidator) : Validator<Order>
                                                                         {
                                                                       ...
                                                                       namespace Test.Validators
                                                                       {
                                                                           ...
                                                                           public partial class OrderValidator : global::ValiCraft.IValidator<global::Test.Requests.Order>
                                                                           {
                                                                               ...
                                                                               private global::System.Collections.Generic.List<global::ErrorCraft.IValidationError>? RunValidationLogic(global::Test.Requests.Order request, string? inheritedTargetPath)
                                                                               {
                                                                                   ...
                                                                                   var errors2 = customerValidator.ValidateToList(request.Customer, $"{inheritedTargetPath}Customer.");
                                                                                   if (errors2.Count != 0)
                                                                                   {
                                                                                       if (errors is null)
                                                                                       {
