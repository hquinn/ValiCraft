...
public class SingleEnsureRuleChain_AsyncSingleIsMethodRuleUsingMemberAccess_AllOverrides_AllOverridesTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
                                                                         ...
                                                                         public partial class OrderValidator : AsyncValidator<Order>
                                                                         {
                                                                             protected override void DefineRules(IAsyncValidationRuleBuilder<Order> orderBuilder)
                                                                             {
                                                                                 orderBuilder.Ensure(x => x.OrderNumber)
                                                                                    .Is(TestAsyncRules.OrderNumberValid, "tenant", "tenant2")
