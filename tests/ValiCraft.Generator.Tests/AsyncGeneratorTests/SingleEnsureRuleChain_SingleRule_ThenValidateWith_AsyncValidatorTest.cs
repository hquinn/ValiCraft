...
public class SingleEnsureRuleChain_SingleRule_ThenValidateWith_AsyncValidatorTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
    ...
    // Using IAsyncValidator for nested validation - should generate await RunValidationAsync call
    [StringSyntax("CSharp")] private const string InputValidatorsToGenerate = """
                                                                        ...
                                                                        [GenerateValidator]
                                                                        public partial class OrderValidator(IAsyncValidator<Customer> asyncCustomerValidator) : AsyncValidator<Order>
                                                                        {
                                                                            protected override void DefineRules(IAsyncValidationRuleBuilder<Order> orderBuilder)
                                                                            {
                                                                                orderBuilder.Ensure(x => x.Customer)
                                                                                   .IsNotNull()
                                                                                   .ValidateWith(asyncCustomerValidator);
                                                                            }
                                                                        }
                                                                        """;
                                                                       ...
                                                                       namespace Test.Validators
                                                                       {
                                                                           ...
                                                                           public partial class OrderValidator : global::ValiCraft.IAsyncValidator<global::Test.Requests.Order>
                                                                           {
                                                                               ...
                                                                               private async global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<global::ValiCraft.ValidationError>?> RunValidationLogicAsync(global::Test.Requests.Order request, string? inheritedTargetPath, global::System.Threading.CancellationToken cancellationToken)
                                                                               {
                                                                                   ...
                                                                                   var errors1 = await asyncCustomerValidator.RunValidationAsync(request.Customer, $"{inheritedTargetPath}Customer.", cancellationToken);
