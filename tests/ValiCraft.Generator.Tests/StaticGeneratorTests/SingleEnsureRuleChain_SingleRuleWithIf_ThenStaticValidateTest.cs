...
public class SingleEnsureRuleChain_SingleRuleWithIf_ThenStaticValidateTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
    ...
    [Fact]
    public void ShouldGenerateStaticValidatorWithConditionalRuleBeforeNestedStaticValidation()
    {
