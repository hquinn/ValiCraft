...
public class SingleEnsureRuleChain_SingleRule_ThenStaticValidateTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
    ...
    [Fact]
    public void ShouldGenerateStaticValidatorWithRuleBeforeNestedStaticValidation()
    {
