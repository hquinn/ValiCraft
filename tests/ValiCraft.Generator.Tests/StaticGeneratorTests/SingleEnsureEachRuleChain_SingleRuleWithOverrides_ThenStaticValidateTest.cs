...
public class SingleEnsureEachRuleChain_SingleRuleWithOverrides_ThenStaticValidateTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
                                                                        ...
                                                                        public partial class OrderValidator : StaticValidator<Order>
                                                                        {
                                                                            protected override void DefineRules(IValidationRuleBuilder<Order> orderBuilder)
                                                                            {
                                                                                orderBuilder.EnsureEach(x => x.LineItems)
                                                                                   .IsNotNull()
                                                                                       .WithMessage("Line item is required")
                                                                                       .WithErrorCode("LI_REQ")
    ...
    [Fact]
    public void ShouldGenerateStaticValidatorWithOverriddenRuleBeforeNestedStaticValidationInEnsureEach()
    {
