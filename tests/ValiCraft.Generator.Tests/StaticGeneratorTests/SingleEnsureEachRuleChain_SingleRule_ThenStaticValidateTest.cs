...
public class SingleEnsureEachRuleChain_SingleRule_ThenStaticValidateTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
    ...
    [Fact]
    public void ShouldGenerateStaticValidatorWithRuleBeforeNestedStaticValidationInEnsureEach()
    {
