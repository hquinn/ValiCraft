...
public class PolymorphicRuleChain_StaticValidateTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
    ...
    [Fact]
    public void ShouldGenerateStaticValidatorWithPolymorphicStaticValidation()
    {
