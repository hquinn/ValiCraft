...
public class PolymorphicRuleChain_MultipleTypesTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
    ...
    [StringSyntax("CSharp")] private const string InputValidatorsToGenerate = """
                                                                         ...
                                                                         public partial class OrderValidator : StaticAsyncValidator<Order>
                                                                         {
                                                                             ...
                                                                             private static IAsyncValidator<CryptoPayment> _cryptoValidator = null!;
                                                                             private static IAsyncValidator<BankTransferPayment> _bankTransferValidator = null!;
                                                                             ...
                                                                             protected override void DefineRules(IAsyncValidationRuleBuilder<Order> builder)
                                                                             {
                                                                                 builder.Polymorphic(x => x.Payment)
                                                                                    ...
                                                                                    .WhenType<CryptoPayment>().ValidateWith(_cryptoValidator)
                                                                                    .WhenType<BankTransferPayment>().ValidateWith(_bankTransferValidator)
                                                                                    .Otherwise().Allow();
                                                                             }
                                                                         }
                                                                         """;
                                                                       ...
                                                                       namespace Test.Validators
                                                                       {
                                                                           ...
                                                                           public partial class OrderValidator : global::ValiCraft.IStaticAsyncValidator<global::Test.Requests.Order>
                                                                           {
                                                                               ...
                                                                               private static async global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<global::ErrorCraft.IValidationError>?> RunValidationLogicAsync(global::Test.Requests.Order request, string? inheritedTargetPath, global::System.Threading.CancellationToken cancellationToken)
                                                                               {
                                                                                   ...
                                                                                   {
                                                                                       var errors1 = await _cryptoValidator.ValidateToListAsync(typedCryptoPayment, $"{inheritedTargetPath}Payment.", cancellationToken);
                                                                                       if (errors1.Count != 0)
                                                                                       {
                                                                                           if (errors is null)
                                                                                           {
                                                                                   ...
                                                                                   {
                                                                                       var errors1 = await _bankTransferValidator.ValidateToListAsync(typedBankTransferPayment, $"{inheritedTargetPath}Payment.", cancellationToken);
                                                                                       if (errors1.Count != 0)
                                                                                       {
                                                                                           if (errors is null)
                                                                                           {
