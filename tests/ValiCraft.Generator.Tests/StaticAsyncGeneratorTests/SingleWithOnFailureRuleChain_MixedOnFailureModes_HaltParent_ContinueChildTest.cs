...
public class SingleWithOnFailureRuleChain_MixedOnFailureModes_HaltParent_ContinueChildTest : IncrementalGeneratorTestBase<ValiCraftGenerator>
{
                                                                         ...
                                                                         public partial class OrderValidator : StaticAsyncValidator<Order>
                                                                         {
                                                                             protected override void DefineRules(IAsyncValidationRuleBuilder<Order> orderBuilder)
                                                                             {
                                                                                 orderBuilder.WithOnFailure(OnFailureMode.Halt, b =>
                                                                                 {
                                                                                     ...
                                                                                     b.EnsureEach(o => o.LineItems, OnFailureMode.Continue, lineItemBuilder =>
                                                                                     {
