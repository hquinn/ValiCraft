...
public class ContainsTests
{
    ...
    {
        var result = ValiCraft.Rules.Contains("hello world", "lo wo");
    ...
    {
        var result = ValiCraft.Rules.Contains("hello world", "xyz");
    ...
    {
        var result = ValiCraft.Rules.Contains(null, "test");
        result.Should().BeFalse();
    }
    ...
    {
        var result = ValiCraft.Rules.Contains("hello", "");
        result.Should().BeTrue();
    }
    ...
    {
        var result = ValiCraft.Rules.Contains("hello", "HELLO");
        result.Should().BeFalse();
    }
}
